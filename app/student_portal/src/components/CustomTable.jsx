...
import ActionTableButton from "./ActionTableButtons";
                ...
                {props.row.map((r) => {
                  return (
                    <TableRow style={{ height: "172px" }}>
                      <TableCell className={styles.customTableP}>
                        {r.id}
                      </TableCell>
                      <TableCell className={styles.customTableP}>
                        {r.achievement}
          ...
          >
            ...
            >
              <TableBody>
                {props.row.map((r) => {
                  return (
                    <TableRow style={{ height: "172px" }} key={r.id}>
                      <TableCell className={styles.customTableP}>
                        {r.id}
                      </TableCell>
                      <TableCell className={styles.customTableP}>
                      ...
                      <TableCell className={styles.customTableP} width="25%">
                        <ActionTableButton reportID={r.id} />
                      </TableCell>
                    </TableRow>
                  );
                })}
