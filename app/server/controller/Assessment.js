...
async function submitTransaction(funcName, ...args) {
    ...
    try {
        ...
        const walletPath = path.join(__dirname, "../../../QutAssessments", "wallet");
...
const getStudent = function(std) {
    return evaluateTransaction('get', std.ID)
}
...
const addAssessment = function(ast, std) {
    return submitTransaction('createAssessment', ast.ID, ast.UnitId, ast.UnitName, ast.AssessmentName,
            JSON.stringify(ast.Criteria), JSON.stringify(ast.Achievement))
        .then(() => {
...
const getAssessment = function(ast) {
    return evaluateTransaction('get', ast.ID)
}

// Add a report
// exports.addReport = function(rpt) {
const addReport = function(rpt) {
    return submitTransaction('createReport', rpt.ID, rpt.StudentID, JSON.stringify(rpt.AssessmentIDs))
}

// Update the report status to 'Approved' (Just for demo since we don't implement admin proto)
// exports.approveReport = function(rpt) {
const approveReport = function(rpt) {
    return submitTransaction('updateState', rpt.ID)
}

// Get a report
// exports.getReport = function(rpt) {
const getReport = function(rpt) {
    return evaluateTransaction('get', rpt.ID)
}
